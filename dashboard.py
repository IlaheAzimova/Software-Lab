...
def show_dashboard(page: ft.Page, user_email: str, on_logout):
        ...
        return ft.Container(
            ...
            content=ft.Column([
                ft.Row(
                    ...
                    controls=[
                        ft.Container(bgcolor=icon_bg, border_radius=8, padding=8,
    ...
    def avatar(initials, size=34, bg="#0f766e22", fg="#0f766e"):
        return ft.Container(
    ...
    def build_dashboard_page():
        ...
        def qa_outline_btn(icon, lbl):
            return ft.Container(
                bgcolor="transparent", border=ft.border.all(1.5, "#0f766e"),
                border_radius=30, padding=ft.padding.symmetric(horizontal=16, vertical=12),
                content=ft.Row([
                    ft.Icon(icon, color="#0f766e", size=18),
                    ft.Text(lbl, size=13, color="#0f766e", weight=ft.FontWeight.W_600),
                ], spacing=10)
            )

        quick_actions = ft.Container(
            bgcolor="#0f766e", border_radius=12,
            ...
            content=ft.Column(spacing=0, tight=True, controls=[
                ...
                ft.Container(
                    ...
                    content=ft.Column([
                        ft.Container(
                            bgcolor="#0f766e", border_radius=30,
        ...
        return ft.Column(
            ...
            controls=[
                ...
                ft.Row(spacing=16, vertical_alignment=ft.CrossAxisAlignment.START, controls=[
                    ft.Container(
                        expand=True, bgcolor=c()["card"], border_radius=12, padding=20,
                        shadow=ft.BoxShadow(blur_radius=8, color=ft.Colors.BLACK12),
                        content=ft.Column([
                            ft.Row(
                                alignment=ft.MainAxisAlignment.SPACE_BETWEEN,
                            ...
                            *assessment_rows,
                            ft.Row(spacing=24, controls=[
                                ft.Container(
                                    ...
                                    content=ft.Row([
                                        ft.Container(bgcolor="#0f766e22", border_radius=8,
                                                     padding=8,
                                ...
                                ft.Container(
                                    ...
                                    border_radius=10, padding=16,
                                    content=ft.Row([
                                        ft.Container(bgcolor="#2563eb22", border_radius=8,
                                                     padding=8,
    ...
    def nav_item(icon, label, page_name, active=False):
    ...
    def switch_page(page_name):
        ...
        if page_name == "Dashboard":
            content_area.current.content = ft.Container(
                ...
                content=build_dashboard_page()
            )
        elif page_name == "Management":
            content_area.current.content = ft.Container(
                expand=True, padding=24,
                content=build_management_page(page, c)
            )
        # Update sidebar highlight
        for pn, ref in sidebar_nav_refs.items():
            is_active = (pn == page_name)
            ref.current.bgcolor = "#f0fdf9" if is_active else "transparent"
            ref.current.content.controls[0].color = "#0f766e" if is_active else c()["muted"]
            ref.current.content.controls[1].color = "#0f766e" if is_active else c()["muted"]
        ...
        content=ft.Row(
            ...
            controls=[
                ...
                ft.Row([
                    ...
                    ft.Container(
                        width=36, height=36, border_radius=18, bgcolor="#0f766e",
                        alignment=ft.Alignment(0, 0),
